    ...
    <div className='About font-montserrat'>
      ...
      <div className='ml-24 my-36 max-[650px]:my-24 max-[650px]:ml-12'>
        ...
        <div className='flex mr-28 max-[650px]:flex-col  max-[650px]:mr-12' >
          <img src="./Rectangle.png" data-aos="fade-right" data-aos-duration="1000" alt="" className='h-[40vh] w-[40vw] mr-10 max-[650px]:h-[25vh] max-[650px]:w-full max-[650px]:mb-10' />
      ...
      <div className='ml-24 my-36 max-[650px]:ml-12 max-[650px]:my-32'>
        ...
        <div className='flex my-7 text-justify text-lg max-[650px]:flex-col  max-[650px]:mr-12'>
          ...
          <img src="./Photo.png" alt="" data-aos="fade-left" data-aos-duration="1000" className='mr-28 h-[40vh] w-[40vw] max-[650px]:mt-10 max-[650px]:w-full max-[650px]:h-[30vh]' />
        </div>
      </div>
    </div>
  );
