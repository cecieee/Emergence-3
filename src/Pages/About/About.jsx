  ...
  return (
    <div className='About font-montserrat'>
      ...
      <div className='ml-24 my-36 max-[450px]:my-24 max-[450px]:ml-12'>
        <h1 className='font-bold text-4xl tracking-wide mb-10' data-aos="fade-up">ABOUT IAS</h1>
        <div className='flex mr-28 max-[450px]:flex-col  max-[450px]:mr-12' >
          <img src="./Rectangle.png" data-aos="fade-right" alt="" className='h-[40vh] w-[40vw] mr-10 max-[450px]:h-[25vh] max-[450px]:w-full max-[450px]:mb-10' />
          <div className='text-justify text-lg' data-aos="fade-left">
      ...
      <div className='ml-24 my-36 max-[450px]:ml-12 max-[450px]:my-32'>
        <h1 className='font-bold text-4xl tracking-wider max-[450px]:tracking-normal' data-aos="fade-up">ABOUT EMERGENCE</h1>
        ...
        <div className='flex my-7 text-justify text-lg max-[450px]:flex-col  max-[450px]:mr-12'>
          <div className='mr-10 max-[450px]:mr-0' data-aos="fade-right" style={{ display: showDiv1 ? 'block' : 'none' }}>
          ...
          <div className='mr-10 max-[450px]:mr-0' data-aos="fade-right" style={{ display: showDiv2 ? 'block' : 'none' }}>
          ...
          <img src="./Photo.png" alt="" data-aos="fade-left" className='mr-28 h-[40vh] w-[40vw] max-[450px]:mt-10 max-[450px]:w-full max-[450px]:h-[30vh]' />
        </div>
      </div>
    </div>
  );
